                ...
                <div class="card-body">
                    ...
                    <div class="mt-4">
                        ...
                        <div class="mt-3 d-flex gap-2 flex-wrap">
                            <button type="button" class="btn btn-outline-secondary btn-sm" onclick="openMediaModal('page-featured')">Choisir une image</button>
...
<script>
function getPageMediaLibraryMap() {
...
function renderPageFeaturedPreview() {
    ...
    var items = getPageMediaLibraryMap();
