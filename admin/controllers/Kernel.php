...
class Kernel
{
    ...
    private function handleProducts(string $action): void
    {
        ...
        if ($action === 'create') {
            ...
            $isEdit = false;
            $this->render('Ajouter un produit', $this->resolveView(['modules/products-form.php']), compact('product', 'productCategories', 'selectedCategoryIds', 'allAttributes', 'attributeTermsMap', 'selectedAttributeIds', 'selectedAttributeTerms', 'isEdit'));
            return;
        }
        ...
        if ($action === 'edit') {
            ...
            $isEdit = true;
            $this->render('Modifier un produit', $this->resolveView(['modules/products-form.php']), compact('product', 'productCategories', 'selectedCategoryIds', 'allAttributes', 'attributeTermsMap', 'selectedAttributeIds', 'selectedAttributeTerms', 'isEdit'));
            return;
        }
