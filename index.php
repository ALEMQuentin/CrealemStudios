...
<button class="btn" type="submit" name="connexion" value="Connexion">Connexion</button></form>
<?php
...
<input type="text" name="login" value="<?php if (isset($_POST['login'])) echo htmlentities(trim($_POST['login'])); ?>" placeholder="Login" required class="input"><br />
<input type="password" name="pass" value="<?php if (isset($_POST['pass'])) echo htmlentities(trim($_POST['pass'])); ?>" placeholder="mot de passe" required class="input"><br />
<input type="password" name="pass_confirm" value="<?php if (isset($_POST['pass_confirm'])) echo htmlentities(trim($_POST['pass_confirm'])); ?>" placeholder="confirmer votre mot de passe" required class="input"><br />
<button class="btn" type="submit" name="inscription" value="Inscription">Inscription</button>
</form>
<?php
